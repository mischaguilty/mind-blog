...
//        });
        ...
        Schema::create(config('admin.database.role_users_table'), function (Blueprint $table) {
            $table->foreignIdFor(\Encore\Admin\Auth\Database\Role::class, 'role_id')->constrained('roles')->cascadeOnDelete();
        ...
        Schema::create(config('admin.database.role_permissions_table'), function (Blueprint $table) {
            $table->foreignIdFor(\Encore\Admin\Auth\Database\Role::class, 'role_id')->constrained('roles')->cascadeOnDelete();
            $table->foreignIdFor(\Encore\Admin\Auth\Database\Permission::class, 'permission_id')->constrained('permissions')->cascadeOnDelete();
        ...
        Schema::create(config('admin.database.role_menu_table'), function (Blueprint $table) {
            $table->foreignIdFor(\Encore\Admin\Auth\Database\Role::class, 'role_id')->constrained('roles')->cascadeOnDelete();
            $table->foreignIdFor(\Encore\Admin\Auth\Database\Menu::class, 'menu_id')->constrained('menu')->cascadeOnDelete();
